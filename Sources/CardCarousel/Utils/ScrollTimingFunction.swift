...
// https://github.com/qyz777/scroll_animation
enum ScrollTimingFunction {
    case linear
    case quadIn
    case quadOut
    case quadInOut
    ...
    case circleOut
    case circleInOut
    case custom((CGFloat, CGFloat, CGFloat, CGFloat) -> CGFloat)
}
